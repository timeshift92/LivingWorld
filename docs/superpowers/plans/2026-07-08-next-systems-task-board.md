...
| Task 6 | Conflict campaigns (`WorldConflict`) | Codex core + Claude summaries | ◐ | Core foundation landed: `WorldConflict`, `ConflictClaim`, exhaustion, truce blocking, battle/capture claim updates, war-refugee accounting, save/load covered. RW summaries/letters still pending. |
